...
Token* getToken(void) {
  ...
  case CHAR_PLUS: 
    ...
    if((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) {
      readChar();
      return makeToken(SB_PLUSEQ, lineNo, colNo);
  ...
  case CHAR_MINUS:
    ...
    if((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) {
      readChar();
      return makeToken(SB_MINUSEQ, lineNo, colNo);
  ...
  case CHAR_TIMES:
    ...
    if((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) {
      readChar();
      return makeToken(SB_TIMESEQ, lineNo, colNo);
  ...
  case CHAR_SLASH:
    ...
    if((currentChar != EOF) && (charCodes[currentChar] == CHAR_EQ)) {
      readChar();
      return makeToken(SB_SLASHEQ, lineNo, colNo);
...
void printToken(Token *token) {
  ...
  case SB_PLUSEQ: printf("SB_PLUSEQ\n"); break;
  case SB_MINUSEQ: printf("SB_MINUSEQ\n"); break;
  case SB_TIMESEQ: printf("SB_TIMESEQ\n"); break;
  case SB_SLASHEQ: printf("SB_SLASHEQ\n"); break;
  }
}
